...
# TODO: kill -2 and listen for the signal in the app
kill_command='cat ~/.home_dashboard_pid | ps -p $(xargs -I{} echo {}) && kill $(cat ~/.home_dashboard_pid) && echo "Stopped running app" || echo "App is not running"'
